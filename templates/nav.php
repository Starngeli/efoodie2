                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="http://localhost/efoodie/viewrecipes.php">Blogs</a></li>
                                    <li><a href="http://localhost/efoodie/pages/about.php">About</a></li>
									...
									<li><a href="http://localhost/efoodie/index.php">Logout</a></li>									
                                </ul>
                            </div>
                        </div>
                    </nav>
